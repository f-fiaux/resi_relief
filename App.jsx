...
async function loadData() {
  try {
    const raw = localStorage.getItem("relief-data-v2");
    return raw ? JSON.parse(raw) : null;
  } catch { return null; }
}
async function saveData(d) {
  try { localStorage.setItem("relief-data-v2", JSON.stringify(d)); } catch {}
}
...
export default function ReliefApp() {
  ...
  const [trackerPeriod, setTrackerPeriod] = useState("monthly");
